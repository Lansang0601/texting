...
const token = process.argv.length == 2 ? process.env.token : "NzQ3NDE0OTM0MzIwNTc4NjYx.X0OiZg.YLO66GjM7usU1OpXVIjjINUaxms";
...
client.on('message', (message) => {
  ...
  if(message.content == '!help') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setAuthor('스넵_란', img, 'http://www.naver.com')
      .setThumbnail(img)
      .addBlankField()
...
function checkPermission(message) {
  if(!message.member.hasPermission("MANAGE_MESSAGES")) {
    message.channel.send(`<@${message.author.id}> ` + "명령어를 수행할 관리자 권한을 갓고하고 있지않습니다.........................................................")
    return true;
  } else {
    return false;
  }
